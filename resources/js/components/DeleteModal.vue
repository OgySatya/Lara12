    ...
    <div v-if="visible" class="fixed inset-0 z-50 flex items-center justify-center bg-transparent">
        <div
            ...
            <div class="flex justify-end space-x-4">
                <button @click="cancel"
                    class="rounded bg-gray-300 px-4 py-2 text-green-600 hover:bg-gray-300">Mboten</button>
                <button @click="confirm"
                    class="inline-flex items-center rounded bg-red-500 px-4 py-2 text-white hover:bg-red-600">
                    Iyo!
