                        ...
                        <td class="border p-2">
                            <div class="space-y-4">
                                <div class="flex cursor-pointer items-center space-x-3">
                                    ...
                                    />
                                    <label for="shift1" class="text-sm text-gray-700">Shift 1</label>
                                </div>
                                ...
                                <div class="flex cursor-pointer items-center space-x-3">
                                    ...
                                    />
                                    <label for="shift2" class="text-sm text-gray-700">Shift 2</label>
                                </div>
                            </div>
                        </td>
                        <td class="border p-2 text-white">
                            <div class="flex justify-center rounded-sm p-2" :class="user.status ? 'bg-blue-500' : 'bg-gray-500'">
                                <LoaderCircle v-if="user.status" class="mx-2 h-5 w-5 animate-spin" />
                                <span>{{ user.status ? 'Proses...' : 'Standby' }}</span>
                            </div>
                        </td>
                        <td class="border p-2">
                            <button
                                @click="submit(index, user.id, user.status)"
                                :class="user.status ? 'bg-red-500' : 'bg-emerald-500'"
                                class="rounded-sm p-2 text-white"
                            >
