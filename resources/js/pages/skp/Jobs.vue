...
const sedoyo = ref(false);
const openSedoyo = (id: number) => {
    sedoyo.value = true;
    form.user_id = props.user.id;
    form.target_id = id;
}
const deleteSedoyo = () => {
    ...
    form.delete(route('delete.sedoyo'), {
            onFinish: () => form.reset(),
        });
        sedoyo.value = false;
};
        ...
        <div class="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
            ...
            <div class="flex w-full justify-between">
                ...
                <Button
                    ...
                    class="mb-2 me-2 rounded-full bg-gradient-to-br from-pink-400 to-orange-400 px-3 py-2 text-center text-sm font-medium text-white hover:bg-gradient-to-bl focus:outline-none focus:ring-4 focus:ring-cyan-300 dark:focus:ring-cyan-800"
                >
                ...
                <Button
                    ...
                    :disabled="isGenerating"
                    class="mb-2 me-2 rounded-full bg-gradient-to-br from-violet-400 to-fuchsia-400 px-3 py-2 text-center text-sm font-medium text-white hover:bg-gradient-to-bl focus:outline-none focus:ring-4 focus:ring-cyan-300 dark:focus:ring-cyan-800"
                >
                    ...
                    <div class="my-4 grid grid-cols-1 gap-4 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <DeleteModal
                                ...
                                :deleting="false"
                                title="Nyuwun sewu"
                                message="Yakin Hapus Foto sedoyo Boss?"
                                @confirm="deleteSedoyo"
                                @cancel=" (sedoyo = false, form.reset())"
                            />
                        </div>
                </div>
            </div>
